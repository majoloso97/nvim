return {
	{ -- LSP Configuration & Plugins
		...
		config = function()
			...
			--
			-- For termux compatibilty, the clangd and lua_ls lsps have to be added explicitly
			...
			local servers = {
				...
				gopls = { settings = { single_file_support = true } },
				pyright = { settings = { root_files = { "main.py" } } },
				-- rust_analyzer = {},
